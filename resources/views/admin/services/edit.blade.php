...
<body>
   <div class="container">
    <h1>Firma Yazısı Ekle</h1>
    <form action="/admin/blogs/{{$service->id}}" method="POST", enctype="multipart/form-data" id="upload-image" action="{{url('storeService')}}">
        @csrf
        <div class="form-group">
            <label for="title">Hizmet Yazısı Başlığı</label>
