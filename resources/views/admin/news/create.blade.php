...
<body>
   <div class="container">
    <h1>Haber Yazısı Ekle</h1>
    <form action="{{ route('admin.news.store') }}" method="POST", enctype="multipart/form-data" id="upload-image" action="{{url('storeNews')}}">
        @csrf
        ...
        <div class="form-group">
            <label for="description">Haber Yazısı Açıklaması</label>
