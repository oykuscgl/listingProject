...
<body>
   <div class="container">
    <h1>Tüketici Araştırma Yazısı Ekle</h1>
    <form action="{{ route('admin.consumerResearches.store') }}" method="POST", enctype="multipart/form-data" id="upload-image" action="{{url('storeResearch')}}">
        @csrf
