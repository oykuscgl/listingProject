                ...
                @foreach($blogs as $blog)
                    <div class="bg-white p-4 shadow flex flex-wrap">
                        ...
                        <div class="w-full md:w-2/3 p-2">
                            ...
                            <p class="text-red-700 mb-1">{{ $blog->date }}</p>
                            <div class="underline-short mb-2"></div>
                            <p class="badge bg-gray-500 text-white inline-block mb-2">{{ $blog->category }}</p>
                            <p class="text-gray-700 mb-4">{{ $blog->description }}</p>
                            <a href="{{ route('blogs.show', ['blogPost_id' => $blog->id]) }}" class="text-red-500">Daha fazla bilgi</a>
                        </div>
                    </div>
                @endforeach
            </div>
