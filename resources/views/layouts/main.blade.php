         ...
         <div class="card flex-1 mx-2.5 bg-white">
            ...
            <div class="content p-5">
               ...
               <div class="btn text-left my-2.5">
                  <button class="bg-red-600 text-white border-none outline-none text-lg py-1.5 px-2.5 rounded-md cursor-pointer transition-transform transform hover:scale-90">
                     Read more
                  </button>
               </div>
            </div>
...
<div class="bg-gray-200 py-12">
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-3xl text-orange-600 font-semibold tracking-wide uppercase">İlginizi Çekebilecek Konular</h2>
        </div>
...
<div class="flex flex-col gap-4 mt-20">
    ...
    <div class="flex flex-row gap-4">
        <div class="relative group flex-1 bg-red-700 text-white">
            <div class="flex flex-col justify-center items center">
            </div>
            <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 h-96 flex items-center justify-center transition duration-300">
                <span class="text-white text-xl font-semibold">Puratos'un Trendleri ile Yeni Lezzetlere Adım Atın!</span>
            </div>
        </div>
