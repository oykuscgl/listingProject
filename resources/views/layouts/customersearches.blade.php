...
<section class="container-fluid px-4 py-10 mx-auto">
    ...
    @foreach($researches as $research)
                <div class="relative shadow-md rounded-md overflow-hidden h-96">
                     <a href="{{ route('researches.show', ['research_id' => $research->id]) }}">
                    <img src="{{ asset('images/'.$research->image) }}" alt="{{ $research->title }}" class="w-full h-48 object-cover z-10 filter brightness-75">
                    </a>
